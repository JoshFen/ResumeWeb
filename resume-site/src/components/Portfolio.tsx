    ...
    return (
        <Container className="d-flex flex-column justify-content-evenly align-items-center portfolio-cont cont" data-aos="fade-up">
            ...
            <Row className="projects-list">
                ...
                <Col xs={12} md={6} lg={6} data-aos="fade-up" className="p-4">
                    <Project photo="src/assets/SkiMapper.png" title="Ski Resort Navigation" text="Dynamic Django Web App with OSM Integration" primaryLink={links[2]} primaryLinkText="" secondaryLink={links[3]} secondaryLinkText="Git"/>
                </Col>
                <Col xs={12} md={6} lg={6} data-aos="fade-up" className="p-4">
                    <Project photo="src/assets/LionsGate.png" title="Roar-mitory" text="Dorm Room Assignment Application for Penn State's LionsGate Faculty" primaryLink={links[4]} primaryLinkText="" secondaryLink={links[5]} secondaryLinkText="Git"/>
                </Col>
                <Col xs={12} md={6} lg={6} data-aos="fade-up" className="p-4">
                    <Project photo="" title="ASL Reader" text="Real-time ASL Hand Sign Recognition Web App with TensorFlow and MediaPipe" primaryLink={links[6]} primaryLinkText="" secondaryLink={links[7]} secondaryLinkText="Git"/>
                </Col>
            </Row>
